...
LABEL architecture="$ARCH" \
      ...
      summary="This image has a running glusterfs service (CentOS 7 + Gluster 5)" \
...
LABEL description="gluster v5, because they never released this version"
LABEL dockername="theshellland/gluster5"
LABEL dockertag="gluster5"
LABEL version="0.1"

RUN yum --setopt=tsflags=nodocs -y update && yum install -y centos-release-gluster5 && yum clean all && \
